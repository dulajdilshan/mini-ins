...
@section('content')
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <button class="btn btn-info" onclick="window.location.href='/manager_view_customers'" disabled>Customers</button>
                            </div>
                            <div class="col-md-2">
                    ...
                    <div class="panel-body">
                        ...
                        @include('manager.includes.customers_table')
                    </div>
                </div>
            </div>
        </div>
    ...
    @include('manager.includes.add_customer')
@endsection
